...
author=233boy
# github=https://gh-proxy.com/https://github.com/233boy/sing-box
...
download() {
    ...
    core)
        ...
        [[ $is_core_ver ]] && link="https://gh-proxy.com/https://github.com/${is_core_repo}/releases/download/${is_core_ver}/${is_core}-${is_core_ver:1}-linux-${is_arch}.tar.gz"
        name=$is_core_name
        tmpfile=$tmpcore
        is_ok=$is_core_ok
        ;;
    sh)
        link=https://gh-proxy.com/https://github.com/${is_sh_repo}/releases/latest/download/code.tar.gz
        name="$is_core_name 脚本"
        tmpfile=$tmpsh
        is_ok=$is_sh_ok
        ;;
    jq)
        link=https://gh-proxy.com/https://github.com/jqlang/jq/releases/download/jq-1.7.1/jq-linux-$is_arch
        name="jq"
        tmpfile=$tmpjq
        is_ok=$is_jq_ok
        ;;
...
exit_and_del_tmpdir() {
    ...
    [[ ! $1 ]] && {
        msg err "哦豁.."
        msg err "安装过程出现错误..."
        echo -e "反馈问题) https://gh-proxy.com/https://github.com/${is_sh_repo}/issues"
        echo
        exit 1
    }
    exit
