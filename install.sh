...
author=233boy
# github=https://ghproxy.net/https://github.com/233boy/sing-box
...
download() {
    ...
    core)
        ...
        ;;
    sh)
        link=https://ghproxy.net/https://github.com/${is_sh_repo}/releases/latest/download/code.tar.gz
...
exit_and_del_tmpdir() {
    ...
    [[ ! $1 ]] && {
        msg err "哦豁.."
        msg err "安装过程出现错误..."
        echo -e "反馈问题) https://ghproxy.net/https://github.com/${is_sh_repo}/issues"
        echo
        exit 1
    }
    exit
